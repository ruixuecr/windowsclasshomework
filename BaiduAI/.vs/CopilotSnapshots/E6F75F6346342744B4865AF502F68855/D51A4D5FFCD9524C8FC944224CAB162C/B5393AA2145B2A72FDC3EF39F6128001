...
namespace BaiduAI.Common
{
    public static class ValidHelper
    {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static string TryToStringValue(this object obj)
        {
            if (obj != null)
                return obj.ToString();
            return "";
        ...
        public static int TryToInt(this object str, int fail = -1)
        {
            ...
            {
                if (!int.TryParse(BaiduAI.Common.Extensions.TryToString(str), out res))
                    res = fail;
            }
        ...
        {
            double d = 0;
            if (!double.TryParse(BaiduAI.Common.Extensions.TryToString(str), out d))
                d = 0;
            if (double.IsNaN(d))
                return 0;
            d = Math.Round(d, 2);
        ...
        {
            float f = 0;
            if (!float.TryParse(BaiduAI.Common.Extensions.TryToString(str), out f))
                f = 0;
            return f;
        }
        ...
        public static DateTime TryToDateTime(this object str)
        {
            ...
            if (!DateTime.TryParse(BaiduAI.Common.Extensions.TryToString(str), out res))
        ...
        {
            bool res = false;
            if (!bool.TryParse(BaiduAI.Common.Extensions.TryToString(str), out res))
                res = false;
            return res;
        }
        /// <summary>
        ...
        {
            decimal res = 0;
            if (!decimal.TryParse(BaiduAI.Common.Extensions.TryToString(str), out res))
                res = 0;
            return res;
        }
        ...
        {
            long res = 0;
            if (!long.TryParse(BaiduAI.Common.Extensions.TryToString(str), out res))
                res = fail;
            return res;
        }
        /// <summary>
